    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="container" overflow="auto">
            <div class="container-contact100" overflow="auto">
                <form class="contact100-form validate-form" method="post" action="Empleados">
                    <span class="contact100-form-title">
                        Ver Empleados
                    </span>


                    <table id="table_id" class="table display AllDataTables"  style="font-size: 12px;">
                        ...
                        <tbody>
                            <%
                                Empleado EmpleadoVO = new Empleado();
                                EmpleadoDao EmpDAO = new EmpleadoDao(EmpleadoVO);
                                ArrayList<Empleado> ListarEmpleados = EmpDAO.listar();
                                for (int i = 0; i < ListarEmpleados.size(); i++) {
                                    EmpleadoVO = ListarEmpleados.get(i);
                            %>
                            <tr>

                                <td>
                                    <%= EmpleadoVO.getIdEmpleado()%>
                                </td>

                                <td>
                                    <%= EmpleadoVO.getNombre()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getApellido()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getTelefono()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getDireccion()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getCorreo()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getObservacion()%>
                                </td>
                                <td>
                                    <%= EmpleadoVO.getEstado()%>
                                </td>
                                <td>

                                    <a href="actualizarEmpleado.jsp?id=<%= EmpleadoVO.getIdEmpleado()%>" title="Modificar Producto">Actualizar</a>
                                </td>
                        ...
                        <form class="contact100-form validate-form" method="post" action="_Reportes/_empleados.jsp">
