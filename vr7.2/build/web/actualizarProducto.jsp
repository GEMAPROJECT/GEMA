            ...
            <div class="container-contact100">
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="Producto">
                        <%
                            ...
                            ArrayList<ProductoVO> Actualizarprodu = ProDAO2.listarSerial(serial);
                            for (int i = 0; i < Actualizarprodu.size(); i++) {
                                ProVO2 = Actualizarprodu.get(i);
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                            ...
                            <input class="input100" type="text" name="id_producto" maxlength="20" value="<%= ProVO2.getIdProducto()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite el nombre del producto">
                            <span class="label-input100">Nombre*</span>
                            <input class="input100" type="text" onkeypress="return soloLetras(evet)" name="nombre" maxlength="40" value="<%= ProVO2.getNombre()%>">
                        </div>
                        ...
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite el tipo de producto">
                            ...
                            <input class="input100" type="text" onkeypress="return soloLetras(evet)" name="tipo_producto" maxlength="50" value="<%= ProVO2.getTipoProducto()%>">
                        </div>
                        ...
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite la cantidad del producto">
                            ...
                            <input class="input100" type="Number" onkeypress="return soloNumeros(evet)" name="cantidad" maxlength="11" value="<%= ProVO2.getCantidad()%>">
                        </div>
                ...
                <span class="label-input100">Correo *</span>
                        ...
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite la serial del producto">
                            ...
                            <input class="input100" type="text" name="serial" maxlength="20" value="<%= ProVO2.getSerial()%>">
                        </div>

                        <div class="wrap-input100 input100-select bg1">
                            <span class="label-input100">Estado del producto *</span>
                            <div>
                                <select class="js-select2" name="estado" value="<%= ProVO2.getEstado()%>">
                        ...
                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                            ...
                            <textarea class="input100" name="observacion" maxlength="200" value="<%= ProVO2.getObservacion()%>"></textarea>
                        </div>

                        <div class="container-contact100-form-btn">
                            <button onclick="botonAlert()" class="contact100-form-btn">
                                <span>
                                    Actualizar
                                    <i class="fa fa-long-arrow-right m-l-7" aria-hidden="true"></i>
                                </span>
                            </button>
                           <!-- <input type="submit" value="Registrar" class="fa fa-long-arrow-right contact100-form-btn" id="bt1""> -->
