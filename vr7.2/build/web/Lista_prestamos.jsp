<%-- 
    ...
    Created on : 22/10/2019, 06:03:07 PM
    Author     : MAKKMA
--%>
                                                        ...
                                                        <table id="table_id" class="table display AllDataTables" style="width:100%">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Identificación del profesor </th>
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    ...
                                                                    ArrayList<PrestamosVO> listar_prestamos = PreDAO.listar_prestamos();
                                                                    for (int i = 0; i < listar_prestamos.size(); i++) {
                                                                        PreVO = listar_prestamos.get(i);
                                                                %>

                                                                <tr>
                                                                    <td>
                                                                        <%= PreVO.getNum_prestamo()%>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <%= PreVO.getId_profesor()%>
                                                                    </td>
                                                                    <td>
                                                                        <%= PreVO.getFecha_pres()%>
                                                                    </td>
                                                                    <td>
                                                                        <%= PreVO.getFecha_devo_pres()%>
                                                                    </td>    
                                                                    <td>
                                                                        <%= PreVO.getSerial()%>
                                                                    </td> 
                                                                    <td>                
                                                                        <a href="Finalizar_Prestamo.jsp?id=<%= PreVO.getId_detalle()%>&id2=<%= PreVO.getSerial()%>&id3=<%= PreVO.getNum_prestamo()%>" title="Finalizar">Finalizar préstamos</a>
                                                                    </td>
                                        ...
                                        <div class="modal" id="img1">   
                                            <div class="imagen">
                                                ...
                                                <div id="contenedor_box">
                                                    <form method="post" action="Lista_prestamos.jsp">  
