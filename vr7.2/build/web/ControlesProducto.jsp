		...
		Ver Controles de producto
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <%= contrVO.getNombre_producto()%>
                        </td>
                        <td>
                            <%= contrVO.getId_estudiante()%>
                        </td>
                        <td>
                            <%= contrVO.getNombre_estudiante()%>
                        </td>
                        <td>
                            <%= contrVO.getId_curso()%>
                        </td>    
                        <td>
                            <%= contrVO.getId_profesor()%>
                        </td> 
                        <td>
                            <%= contrVO.getId_empleado()%>
                        </td> 
                        <td>
                            <%= contrVO.getDescripcion()%>
                        </td> 
                        <td>
                            <%= contrVO.getEstado()%>
                        </td> 
