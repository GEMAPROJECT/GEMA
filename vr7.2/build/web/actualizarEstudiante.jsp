...
<body>
        ...
        <div class="container">
            ...
            <div class="container-contact100">
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="Estudiante">
                        <%
                            String Id_estudiante = request.getParameter("id");
                            estudianteVO EstuVO2 = new estudianteVO();
                            estudianteDAO EstuDAO2 = new estudianteDAO(EstuVO2);
                            ArrayList<estudianteVO> ActualizarEstu = EstuDAO2.listarEstudiantes(Id_estudiante);
                            for (int i = 0; i < ActualizarEstu.size(); i++) {
                                EstuVO2 = ActualizarEstu.get(i);
                        ...
                        <span class="contact100-form-title">
                         ...
                         <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                            <span class="label-input100">Identificacion del Estudiante*</span>
                            <input class="input100" type="text" onkeypress="return soloNumeros(evet)" name="txt_id_estudiante" maxlength="15" placeholder="Escribe la Identificacion del Estudiante" value="<%= EstuVO2.getId_estudiante()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El nombre el obligatorio" >
                            <span class="label-input100">Nombre*</span>
                            <input class="input100" type="text" name="txt_nombre" onkeypress="return soloLetras(evet)" maxlength="60" placeholder="Escribe el Nombre del Estudiante" value="<%= EstuVO2.getNombre_estudiante()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El Apellido es obligatoria">
                            <span class="label-input100">Apellido*</span>
                            <input class="input100" type="text" name="txt_apellido" onkeypress="return soloLetras(evet)" maxlength="60" placeholder="Escribe el Apellido del estudiante" value="<%= EstuVO2.getApellidos_studiante()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="el curso es obligatorio">
                            <span class="label-input100">Curso</span>
                            <input class="input100" type="text" name="txt_id_curso" onkeypress="return soloNumeros()(evet)" maxlength="11" placeholder="Digite la identificacion del curso" value="<%= EstuVO2.getId_curso()%>">
                        </div>


                        <div class="wrap-input100 input100-select bg1">
                            <span class="label-input100">Estado del Estudiante *</span>
                            <div>
    ...
    <div class="clearfix"></div>
        ...
        <script src="scripts_globales.js" type="text/javascript"></script>
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="actualizarEstudiante.jsp">  
                                                <button class="btn12" id="btnalert" value="Enter" >Oc</button>           
                                            </form> 
                                        </div>      
                                    </div>
                                </div>             
