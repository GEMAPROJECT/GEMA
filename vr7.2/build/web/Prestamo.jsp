                            ...
                            <nav class="navbar navbar-expand-sm navbar-default">
                                <div id="main-menu" class="main-menu collapse navbar-collapse">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="container-contact100">
                                                <div class="wrap-contact100">
                                                    <form class="contact100-form validate-form" method="post" action="Prestamos">
                                                        ...
                                                        <%
                                                            ...
                                                            ProfesorDAO ProfDAO = new ProfesorDAO(ProfVO);
                                                            ArrayList<ProfesorVO> listaProducto = ProfDAO.listar();
                                                            for (int i = 0; i < listaProducto.size(); i++) {
                                                                ProfVO = listaProducto.get(i);
                                                            }
                                                        ...
                                                        <input class="input100" type="hidden" name="textid_emple" value="<%= usuVO.getUsuId()%>">                           
                                                        <div class="wrap-input100 input100-select bg1">
                                                            <span class="label-input100">Identificación del profesor</span>
                                                            <div>
                                                                <input class="input100" type="text" name="textid_Profe">
                                                                <div class="dropDownSelect2"></div>
                                                            </div>
                                                        </div>

                                                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            <span class="label-input100">Fecha del préstamo</span>
                                                            <div>
                                                                <input class="input100" type="date" name="textfecha_presta">
                                                                <div class="dropDownSelect2"></div>
                                                            </div>
                                                        </div>

                                                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            <span class="label-input100">Fecha de devolución del préstamo</span>
                                                            <div>

                                                                <input class="input100" type="date" name="textfecha_devo_presta">
                                                                <div class="dropDownSelect2"></div>
                                                            </div>
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Hora Es Obligatoria">
                                                            <span class="label-input100">Hora de entrega del préstamo:</span>
                                                            <div>
                                                                <select class="js-select2" name="textHora_presta">
                                                                    <option value="1">6:20 a 7:20</option>
                                                                    <option value="2">7:20 a 8:20</option>
                                                                    <option value="3">8:20 a 9:10</option>
                                                                    <option value="4">9:10 a 10:10</option>
                                                                    <option value="5">10:40 a 11:30</option>
                                                                    <option value="6">11:30 a 12:20</option>
                                                                    <option value="7">1:00 a 2:00</option>
                                                                    <option value="8">2:00 a 3:00</option>
                                                                </select>
                                                                <div class="dropDownSelect2"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Hora Es Obligatoria">
                                                            <span class="label-input100">hora de devolucion del préstamo:</span>
                                                            <div>
                                                                <select class="js-select2" name="textHora_devo_presta">
                                                                    <option value="1">6:20 a 7:20</option>
                                                                    <option value="2">7:20 a 8:20</option>
                                                                    <option value="3">8:20 a 9:10</option>
                                                                    <option value="4">9:10 a 10:10</option>
                                                        ...
                                                        <input class="input100" type="hidden" name="textEstado" value="Activo">
                                    ...
                                    <script type="text/javascript">
                                        function validar()
                                        {
                                            var Nprestamo = document.getElementsByName("textnum_presta").value;
                                            var idempleado = document.getElementsByName("textid_emple").value;
                                            var nombreEmple = document.getElementsByName("textNom_emple").value;
                                            var curso = document.getElementsByName("textCurso").value;
                                            var estado = document.getElementsByName("textEstado").value;
                                            if (Nprestamo !== null || idempleado !== null || nombreEmple !== null || curso !== null || estado !== null)
                                            {

                                            } else
                                            {
                                                alert("Hay campos que se encuentran en blanco");
                                            }
                                        }
                                    </script>
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="Prestamo.jsp">  
                                                <button class="btn12" id="btnalert" value="Enter" >Enter</button>           
                                            </form> 
                                        </div>      
                                    </div>
                                </div>             
