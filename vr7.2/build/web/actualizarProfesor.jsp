                ...
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="profesores">
                        ...
                        <span class="contact100-form-title">
                         ...
                         <%
                            String id_profesor = request.getParameter("id");
                            ProfesorVO ProVO2 = new ProfesorVO();
                            ProfesorDAO ProDAO2 = new ProfesorDAO(ProVO2);
                            ArrayList<ProfesorVO> Actualizarprofe = ProDAO2.listarProfesor(id_profesor);
                            for (int i = 0; i < Actualizarprofe.size(); i++) {
                                ProVO2 = Actualizarprofe.get(i);
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                            ...
                            <input class="input100" type="text" name="id_Profesor" maxlength="20" placeholder="Escribe la Identificacion de Profesor"  value="<%= ProVO2.getId_Profesor()%>" readonly="true">
                        </div>
                       
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El nombre es olbigatorio">
                            <span class="label-input100">Nombre *</span>
                            <input class="input100" type="text" onkeypress="return soloLetras(evet)" name="nombre" maxlength="40" placeholder="Escribe el Nombre del producto" value="<%= ProVO2.getNombre()%>">
                        </div>
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El apellido es obligatorio">
                            <span class="label-input100">Apellido *</span>
                            <input class="input100" type="text" onkeypress="return soloLetras(evet)" name="apellido" maxlength="40" placeholder="Escribe el Apellido del Profesor" value="<%= ProVO2.getApellido()%>">
                        </div>
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El Telefono es obligatorio">
                            <span class="label-input100">Telefono *</span>
                            <input class="input100" type="number" onkeypress="return soloNumeros(event)" name="telefono" maxlength="12" placeholder="Escribe el Telefono del Profesor" value="<%= ProVO2.getTelefono()%>">
                        </div>
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="La dirección es obligatoria">
                            <span class="label-input100">Dirección *</span>
                            <input class="input100" type="text" name="direccion" maxlength="30" placeholder="Escribe la direccion del Profesor" value="<%= ProVO2.getDireccion()%>">
                        </div>
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "El correo es obligatorio (e@a.x)">
                            <span class="label-input100">Correo *</span>
                            <input class="input100" type="text" name="correo" maxlength="50" placeholder="Escribe el correo del Profesor" value="<%= ProVO2.getCorreo()%>">
                        </div> 

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "El cargo es obligatorio ">
                            <span class="label-input100">Cargo del profesor *</span>
                            <input class="input100" type="text" onkeypress="return soloLetras(evet)" name="cargo" maxlength="40" placeholder="Escribe el cargo del Profesor" value="<%= ProVO2.getCargo()%>">
                        </div> 

                        <div class="wrap-input100 input100-select bg1">
                            <span class="label-input100">Estado del Profesor *</span>
                            <div>
                        ...
                        <div class="container-contact100-form-btn">
                            ...
                            <input class="input100" type="hidden" name="Asunto" value="Actualizacion de datos">
                            <input class="input100" type="hidden" name="mensaje" value="Sus datos han sido actualizados con exito">
                        </div>
                            <% } %>
                    </form>
                </div>
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="actualizarProfesor.jsp">  
