        ...
        switch (opcion) {
            case 1: //Agregar Registro
                ...
                if (emDAO.actualizarRegistro()) {
                    request.setAttribute("MensajeExito", "El Empleado/Administrador se actualizó correctamente!");
                    request.getRequestDispatcher("Empleado.jsp").forward(request, response);
                } else {
                ...
                case 3://Inhabilitar
                if (emDAO.inabilitar()) { 
                    request.setAttribute("MensajeExito", "El Empleado/Administrador se inhabilitó correctamente!");
                } else {
                    request.setAttribute("MensajeError", "¡ El Empleado/Administrador no pudo ser inhabilitado!");                     
                }
                request.getRequestDispatcher("Empleado.jsp").forward(request, response);
                break;
        }
