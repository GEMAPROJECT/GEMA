        ...
        switch (opcion) {
            ...
            case 2://Actualizar Registro
                if (profesorDAO.actualizarRegistro()) {
                    request.setAttribute("MensajeExito", "El Profesor se actualizó correctamente!");
                     request.getRequestDispatcher("Profesor.jsp").forward(request, response);
                } else {
                    request.setAttribute("MensajeError", " NO se pudo  actualizar los datos del profesor correctamente!");
