                                            ...
                                            <div class="container-contact100">
                                                <div class="wrap-contact100">
                                                    <form class="contact100-form validate-form" method="post" action="Controlprofe">
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                                                            <span class="label-input100">Id_control</span>
                                                            <input class="input100" type="text" name="Num_control" value="<%= ID_Control %>">
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite el nombre del producto">
                                                            <span class="label-input100">id_detalle</span>
                                                            <input class="input100" type="text" name="Num_detalle" value="<%=ControlVO.getId_detalle()%>">
                                                        </div>
                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite el tipo de producto">
                                                            ...
                                                            <input class="input100" type="text" name="" value="<%=ControlVO.getSerial()%>">
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite el tipo de producto">
                                                            <span class="label-input100">id_empleado</span>
                                                            <input class="input100" type="text" name="Id_empleado" value="<%=ControlVO.getId_empleado()%>">
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite la cantidad del producto">
                                                            <span class="label-input100">id_profesor</span>
                                                            <input class="input100" type="Number" name="Id_profesor" value="<%= usuVO.getUsuId() %>">
                                                        </div>
                                                ...
                                                <span class="label-input100">Correo *</span>
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite la serial del producto">
                                                            <span class="label-input100">id_estudiante</span>
                                                            <input type="text" min="0" max="8" class="input100" name="id_estudiante" value="<%=ControlVO.getId_estudiante()%>"  placeholder="Digite la serial del producto">
                                                        </div>
                                                        
                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Digite la serial del producto">
                                                            <span class="label-input100">Nombre_estudiante</span>
                                                            <input type="text" min="0" max="8" class="input100" name="Nombre_estudiante" value="<%=ControlVO.getNombre_estudiante()%>" placeholder="Digite la serial del producto">
                                                        </div>
                                                        ...
                                                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            ...
                                                            <textarea class="input100" name="Observacion" value="<%=ControlVO.getDescripcion()%>" placeholder="Observaciones del Producto..."></textarea>
                                                        </div>
