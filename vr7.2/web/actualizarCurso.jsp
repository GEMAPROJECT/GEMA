       ...
       <div class="container">
            ...
            <div class="container-contact100">
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="Curso">
                        ...
                        <%
                            ...
                            ArrayList<CursosVO> ActualizarCur = CurDAO.listarCurso(Curso);
                            for (int i = 0; i < ActualizarCur.size(); i++) {
                                CurVO = ActualizarCur.get(i);
                        %>

                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                            <span class="label-input100">Identificacion del Curso*</span>
                            <input class="input100" type="number" onkeypress="return soloNumeros(evet)" maxlength="5" name="txt_id_curso" value="<%= CurVO.getIdCurso()%>" >
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="La identificacion del profesor es obligatoria">
                            <span class="label-input100">identifiacion profesor*</span>
                            <input class="input100" type="text" name="txt_id_profe" onkeypress="return soloNumeros(evet)"maxlength="20" value="<%= CurVO.getIdprofesor()%>"  placeholder="Escribe la identificacion del profesor">
                        </div>
                        <% }%>
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="actualizarCurso.jsp">  
