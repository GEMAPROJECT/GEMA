                ...
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="Curso">
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                            <span class="label-input100">Identificación del Curso*</span>
                            <input class="input100" type="number" onkeypress="return soloNumeros(evet) " name="txt_id_curso" maxlength="11" placeholder="Escribe el numero del curso">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="La identificacion del profesor es obligatoria">
                            <span class="label-input100">Identifiación profesor*</span>
                            <input class="input100" type="text" name="txt_id_profe" onkeypress="return soloNumeros(evet)" maxlength="20" placeholder="Escribe la identificacion del profesor">
                        </div>
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="insertarCurso.jsp">  
