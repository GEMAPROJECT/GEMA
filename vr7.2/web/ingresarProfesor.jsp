                                            ...
                                            <div class="container-contact100">
                                                <div class="wrap-contact100">
                                                    <form class="contact100-form validate-form" method="post" action="profesores">
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "El cargo es obligatorio (Profesor)">
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="ingresarProfesor.jsp">  
