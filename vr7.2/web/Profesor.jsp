                                                ...
                                                <div class="container-contact100" overflow="auto">
                                                    <form class="contact100-form validate-form" method="post" action="Profesor">
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered" style="font-size: 12px;">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th class="table-stats table th">identificaion</th>

                                                                    <th class="table-stats table th">Nombre</th>
                                                                    <th class="table-stats table th">Apellidos</th>
                                                                    <th class="table-stats table th">Telefono</th>
                                                                    <th class="table-stats table th">Correo</th>
                                                                    <th class="table-stats table th">Dirección</th>
                                                                    <th class="table-stats table th">Cargo</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class= "table-stats table td">
                                                                        ...
                                                                        <a href="actualizarProfesor.jsp?id=<%= ProfVO.getId_Profesor()%>" title="Modificar Producto">Actualizar</a>
                                                                    </td>
                                                            ...
                                                            <form class="contact100-form validate-form" method="post" action="_Reportes/_profesores.jsp">
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="Profesor.jsp">  
