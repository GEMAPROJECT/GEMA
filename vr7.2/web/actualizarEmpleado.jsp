                ...
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="post" action="Empleado">
                          ...
                          <%
                            ...
                            Empleado EstuVO2 = new Empleado();
                            EmpleadoDao EstuDAO2 = new EmpleadoDao(EstuVO2);
                            ArrayList<Empleado> ActualizarEmple = EstuDAO2.listarEmpleado(Id_estudiante);
                            for (int i = 0; i < ActualizarEmple.size(); i++) {
                                EstuVO2 = ActualizarEmple.get(i);
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion de usuario es Obligatoria">
                            <span class="label-input100">Identificacion del Empleado</span>
                            <input class="input100" type="text" name="IdEmpleado" onkeypress="return soloNumeros()(evet)" maxlength="20" placeholder="Escribe la Identificacion de usuario" value="<%= EstuVO2.getIdEmpleado()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El nombre es olbigatorio">
                            <span class="label-input100">Nombre *</span>
                            <input class="input100" type="text" name="Nombre" onkeypress="return soloLetras(evet)" maxlength="40" placeholder="Escribe el Nombre del producto" value="<%= EstuVO2.getNombre()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El Apellido es obligatorio">
                            <span class="label-input100">Apellido *</span>
                            <input class="input100" type="text" name="Apellido" onkeypress="return soloLetras(evet)" maxlength="40" placeholder="Escribe el Apellido del Empleado" value="<%= EstuVO2.getApellido()%>">
                        </div>

                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El Telefono es obligatorio">
                            <span class="label-input100">Telefono *</span>
                            <input class="input100" type="number" name="Telefono" onkeypress="return soloNumeros(evet)" maxlength="12" placeholder="Escribe el Telefono del Empleado" value="<%= EstuVO2.getTelefono()%>">
                        </div>
                        ...
                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="La direccion es Obligatoria">
                            ...
                            <input class="input100" type="text" name="Direccion" maxlength="30" placeholder="Escribe la direccion del Empleado" value="<%= EstuVO2.getDireccion()%>">
                        </div>


                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "El correo es obligatorio (e@a.x)">
                            <span class="label-input100">Correo *</span>
                            <input class="input100" type="text" name="correo" maxlength="50" placeholder="Escribe el correo del Empleado" value="<%= EstuVO2.getCorreo()%>">
                        </div> 

                        <div class="wrap-input100 input100-select bg1">
                            <span class="label-input100">Estado del Empleado *</span>
                            <div>
