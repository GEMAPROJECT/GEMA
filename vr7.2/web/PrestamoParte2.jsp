            ...
            <div class="container-contact100">
                <div class="wrap-contact100">
                    ...
                    <form class="contact100-form validate-form" method="post" action="DeallePrestamo">                    
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="El Serial Es Obligatorio">
                        ...
                        <input  type="hidden" name="txtCantidad" value="1">
                                ...
                                <div class="modal" id="img1">   
                                    <div class="imagen">
                                        ...
                                        <div id="contenedor_box">
                                            <form method="post" action="PrestamoParte2.jsp">  
