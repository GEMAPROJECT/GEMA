                                            ...
                                            <div class="container-contact100">
                                                <div class="wrap-contact100">
                                                    <form class="contact100-form validate-form" method="post" action="Prestamos">
                                                        <%      
                                                       String serial= request.getParameter("id2");
                                                       String Num_Pres = request.getParameter("id");  
                                                       String Num_Pres2 = request.getParameter("id3"); 
                                                      %>
                                                        ...
                                                        <input class="input100" type="hidden" name="serial" value="<%=serial%>">
                                                        <input class="input100" type="hidden" name="textnum_presta" value="<%=Num_Pres%>">
                                                        <input class="input100" type="hidden" name="textnum_presta2" value="<%=Num_Pres2%>">
                                                        <input class="input100" type="hidden" name="textEstado" value="Inactivo">
                                                        <input class="input100" type="hidden" name="Estado_pre" value="Activo">
                                                       
                                                            <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            <span class="label-input100">Observaciones</span>
                                                            <textarea class="input100" name="observacion" ></textarea>
                                                            </div>
